    ...
    return (
        <div className = "project-page">
            ...
            <ProjectOverview key = "Market2U" 
                            ...
                            info = "<strong>Role:</strong> UX/UI Design, UX Research<br/> <strong>Timeline:</strong> Fall 2022, 4 weeks<br/> <strong>Team:</strong> Ankitha Vasudev, Alice Nie, Parvathy Anand<br/><strong>Tools:</strong> Figma"/>
