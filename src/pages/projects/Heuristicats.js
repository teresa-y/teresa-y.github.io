...
export default function Heuristicats() {
    return(
        <div className = "project-page">
            ...
            info = "<strong>Role:</strong> 2D Art & Animation, UI/UX <br/> <strong>Timeline:</strong> Spring 2023, 6 weeks<br/> <strong>Team:</strong> Jeremia Lo, Adrian Ma, Nellie Tonev<br/><strong>Tools:</strong> Procreate, Figma"/>
